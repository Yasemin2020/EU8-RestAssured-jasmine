...
public class SpartanGetRequests {
    String baseUrl="http://44.202.105.211:8000";
    ...
    //And response Content Type must be application/jason
    ...
    public void test2(){
        ...
        Assertions.assertEquals(response.contentType(), "application/jason");
